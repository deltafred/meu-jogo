...
function gerarBanana(){
  ...
  if(frameCount %40 === 0){
    banana = createSprite(Math.random(0,width-10),height-50,10,40);
...
function gerarlixo(){
  if(frameCount %40 === 0){
    latadelixo = createSprite(Math.random(0,width-10),height-50,10,40);
    latadelixo.addImage(latadelixoImg);
    latadelixo.velocity.y= 5;
...
function gerarCapacete(){
   if(frameCount %40 === 0){
    capacete = createSprite(Math.random(0,width-10),height-50,10,40);
    capacete.addImage(capacete.png);
